...
public class HomeClientController implements Initializable {
        ...
        try {
            ...
            try {
                poster.setImage(new Image("https://via.placeholder.com/140x200/333333/ffffff?text=" +
                    java.net.URLEncoder.encode(film.getTitle(), StandardCharsets.UTF_8)));
            } catch (Exception ex) {
        ...
        try {
            ...
            try {
                poster.setImage(new Image("https://via.placeholder.com/140x200/444444/ffffff?text=" +
                    java.net.URLEncoder.encode(series.getName(), StandardCharsets.UTF_8)));
            } catch (Exception ex) {
        ...
        try {
            ...
            try {
                image.setImage(new Image("https://via.placeholder.com/140x180/555555/ffffff?text=" +
                    java.net.URLEncoder.encode(product.getName(), StandardCharsets.UTF_8)));
            } catch (Exception ex) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                switch (shapeType) {
                    ...
                    case 2: // Triangle (Polygon)
                        ...
                        triangle.getPoints().addAll(0.0, -size,
                            -size * 0.866, size * 0.5,
                            size * 0.866, size * 0.5);
                    ...
                    case 3: // Diamond (Polygon)
                        ...
                        diamond.getPoints().addAll(0.0, -diamondSize,
                            diamondSize, 0.0,
                            0.0, diamondSize,
                            -diamondSize, 0.0);
        ...
        try {
            ...
            try {
                String fallbackUrl = "https://via.placeholder.com/140x200/666666/ffffff?text=" +
                    java.net.URLEncoder.encode(type, StandardCharsets.UTF_8);
    ...
    private VBox createCinemaCard(Cinema cinema) {
        ...
        try {
            ...
            try {
                image.setImage(new Image("https://via.placeholder.com/140x180/555555/ffffff?text=" +
                    java.net.URLEncoder.encode(cinema.getName(), StandardCharsets.UTF_8)));
            } catch (Exception ex) {
