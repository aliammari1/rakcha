...
class _Auth3WidgetState extends State<Auth3Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Auth3'});
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'AUTH3_PAGE_UPLOAD_PHOTO_BTN_ON_TAP');
                                                          logFirebaseEvent(
                                                            ...
                                                            if (selectedUploadedFiles
                                                                ...
                                                                downloadUrls
                                                                    ...
                                                                    selectedMedia
                                                                        .length) {
                                                              safeSetState(() {
                                                                _model.uploadedLocalFile_uploadDataCreate =
                                                                    selectedUploadedFiles
                                                                        .first;
                                                                _model.uploadedFileUrl_uploadDataCreate =
                                                                    downloadUrls
                                                                        .first;
                                                              });
                                                            } else {
                                                  ...
                                                  Stack(
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'AUTH3_PAGE_Container_x3qojmtt_ON_TAP');
                                                          logFirebaseEvent(
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'AUTH3_PAGE_GET_STARTED_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                    ...
                                                    await UsersRecord.collection
                                                        ...
                                                        .update(
                                                          ...
                                                          photoUrl: _model
                                                              .uploadedFileUrl_uploadDataCreate,
                                                          displayName:
                                                              '${_model.firstNameCreateTextController.text} ${_model.lastNameCreateTextController.text}',
                                                        ));
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'AUTH3_CONTINUE_WITH_GOOGLE_BTN_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Button_auth');
                                                              GoRouter.of(
                                                                      context)
                                                            ...
                                                            : Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'AUTH3_CONTINUE_WITH_APPLE_BTN_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Button_auth');
                                                                    GoRouter.of(
                                                                            context)
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'AUTH3_PAGE_FORGOT_PASSWORD_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_navigate_to');
