...
export 'add_film_model.dart';

class AddFilmWidget extends StatefulWidget {
  const AddFilmWidget({super.key});

  static String routeName = 'addFilm';
  static String routePath = '/addFilm';

  @override
  State<AddFilmWidget> createState() => _AddFilmWidgetState();
}

class _AddFilmWidgetState extends State<AddFilmWidget> {
  late AddFilmModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddFilmModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'addFilm'});
    _model.nameFilmTextController ??= TextEditingController();
    _model.nameFilmFocusNode ??= FocusNode();

    _model.desFilmTextController1 ??= TextEditingController();
    _model.desFilmFocusNode1 ??= FocusNode();

    _model.desFilmTextController2 ??= TextEditingController();
    _model.desFilmFocusNode2 ??= FocusNode();

    _model.desFilmTextController3 ??= TextEditingController();
    _model.desFilmFocusNode3 ??= FocusNode();

    _model.dateOfBirthCreateTextController ??= TextEditingController();
    _model.dateOfBirthCreateFocusNode ??= FocusNode();

    _model.dateOfBirthCreateMask = MaskTextInputFormatter(mask: '##/##/####');
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ADD_FILM_arrow_back_rounded_ICN_ON_TAP');
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ADD_FILM_PAGE_UPLOAD_IMAGE_BTN_ON_TAP');
                              logFirebaseEvent(
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadData123 = true);
                                ...
                                try {
                                  ...
                                  _model.isDataUploading_uploadData123 = false;
                                }
                        ...
                        Padding(
                          ...
                          child: Container(
                            width: 350.0,
                            child: TextFormField(
                              controller: _model.desFilmTextController3,
                              focusNode: _model.desFilmFocusNode3,
                              onChanged: (_) => EasyDebounce.debounce(
                                '_model.desFilmTextController3',
                                Duration(milliseconds: 2000),
                                () => safeSetState(() {}),
                              ),
                              autofocus: true,
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: _model
                                        .desFilmTextController3!.text.isNotEmpty
                                    ? InkWell(
                                        onTap: () async {
                                          _model.desFilmTextController3
                                              ?.clear();
                              ...
                              keyboardType: TextInputType.emailAddress,
                              validator: _model.desFilmTextController3Validator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode:
                                        _model.dateOfBirthCreateFocusNode,
                                    autofocus: true,
                                    autofillHints: [AutofillHints.birthday],
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Year of Film',
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ADD_FILM_PAGE_Container_0redqkat_ON_TAP');
                                    logFirebaseEvent(
                                    ...
                                    safeSetState(() {
                                      ...
                                      _model.dateOfBirthCreateMask.updateMask(
                                        newValue: TextEditingValue(
                                          text: _model
                                              .dateOfBirthCreateTextController!
                                              .text,
                                        ),
                                      );
                                    });
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ADD_FILM_PAGE_ADD_FILM_BTN_ON_TAP');
                              ...
                              await FilmRecord.collection.doc().set({
                                ...createFilmRecordData(
                                  name: _model.nameFilmTextController.text,
                                  description:
                                      _model.desFilmTextController1.text,
                                  image: _model.uploadedFileUrl_uploadData123,
                                  year: _model.datePicked,
                                  prix: int.tryParse(
                                      _model.desFilmTextController2.text),
                                  path: _model.desFilmTextController3.text,
                                ),
                                ...mapToFirestore(
                                  {
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ADD_FILM_PAGE_LIST_OF_FILMS_BTN_ON_TAP');
                              logFirebaseEvent('Button_navigate_to');
